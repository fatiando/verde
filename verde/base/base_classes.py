    ...
    * Estimated parameters should be stored as attributes with names ending in
    ...
    def grid(
        ...
        **kwargs
        ...
        extra_coords_names = get_extra_coords_names(coordinates, self.extra_coords_name)
...
def get_extra_coords_names(coordinates, basename):
    """
    ...
    >>> basename = "upward"
    >>> coordinates = (-5, 4, 3)
    >>> get_extra_coords_names(coordinates, basename)
    ['upward']

    >>> basename = "extra_coord"
