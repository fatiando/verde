...
class CheckerBoard(BaseGridder):
    ...
    >>> grid = synth.grid(shape=(101, 51))
    >>> print(grid)
    <xarray.Dataset>
    Dimensions:   (easting: 51, northing: 101)
    Coordinates:
      * northing  (northing) float64 -5e+03 -4.95e+03 ...
      * easting   (easting) float64 0.0 100.0 200.0 300.0 ...
    Data variables:
        scalars   (northing, easting) float64 0.0 248.7 ...
    Attributes:
