...
First let's create a region that is 1555 units west-east and 1250 units south-
north, and we will set an initial spacing to 500 units. 
"""
...
# create some bounds for the region and set the spacing for the grid points
spacing = 500
west = 0
east = 1555
south = 0
...
#
# For the dimensions and spacing we defined above we
...
regioneastpixel, regionnorthpixel = vd.grid_coordinates(
    region=region, spacing=spacing, adjust="region", pixel_register=True
)
...
spacingeastpixel, spacingnorthpixel = vd.grid_coordinates(
    region=region, spacing=500, adjust="spacing", pixel_register=True
)
...
plt.scatter(
    regioneastpixel,
    regionnorthpixel,
    label="Adjust Region Grid Nodes",
    marker="o",
    color="blue",
)
plt.scatter(
    spacingeastpixel,
    spacingnorthpixel,
    label="Adjust Spacing Grid Nodes",
    marker="o",
    color="orange",
)
plt.ylim(-50, 1600)
